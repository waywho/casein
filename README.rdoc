...
For a legacy version that is compatible with Rails 3.x, see: http://github.com/spoiledmilk/casein3, for one that is compatible with Rails 2.x, see: http://github.com/spoiledmilk/casein
